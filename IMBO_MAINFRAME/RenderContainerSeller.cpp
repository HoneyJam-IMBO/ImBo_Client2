...
*/
	...
	m_mTagRenderContainer[t][object_name]->SetShader(RESOURCEMGR->GetRenderShader("WaterT"));
	m_mTagRenderContainer[t][object_name]->AddMaterial(RESOURCEMGR->GetMaterial("Terrain"));
...
void CRenderContainerSeller::TestingRCAdd()
{
	...
	m_mTagRenderContainer[t][object_name]->AddMesh(pMesh[0]);
	m_mTagRenderContainer[t][object_name]->AddTexture(pMesh[0]->GetvMeshTexture()[0]);
	m_mTagRenderContainer[t][object_name]->Begin();
}
