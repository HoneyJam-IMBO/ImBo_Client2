...
void CRenderContainerSeller::TestingRCAdd()
{
	...
	m_mTagRenderContainer[t][CA2CT(object_name.c_str())] = new CRenderContainer();
	m_mTagRenderContainer[t][CA2CT(object_name.c_str())]->SetShader(RESOURCEMGR->GetRenderShader("DEFAULT"));
	m_mTagRenderContainer[t][CA2CT(object_name.c_str())]->AddMesh(pMesh[0]);
	m_mTagRenderContainer[t][CA2CT(object_name.c_str())]->AddTexture(pMesh[0]->GetvMeshTexture()[0]);
	m_mTagRenderContainer[t][CA2CT(object_name.c_str())]->Begin();
}
