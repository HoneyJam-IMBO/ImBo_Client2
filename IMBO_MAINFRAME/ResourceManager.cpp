...
void CResourceManager::CreateRenderShaders() {
	...
	pShader = CRenderShader::CreateRenderShader(L"Effect", 0,
		BIND_VS | BIND_GS | BIND_PS);
	m_mRenderShader.insert(make_pair("Effect", pShader));
	//m_mRenderShader.insert()

	pShader = CRenderShader::CreateRenderShader(L"Blend", 0,
		BIND_VS | BIND_PS);
	m_mRenderShader.insert(make_pair("Blend", pShader));
	//m_mRenderShader.SetAt(CA2CT("Blend"), pShader);

	pShader = CRenderShader::CreateRenderShader(L"FinalPass", 0,
		BIND_VS | BIND_PS);
	m_mRenderShader.insert(make_pair("FinalPass", pShader));
	...
	m_mRenderShader.insert(make_pair("DirectionalLight", pShader));

	pShader = CRenderShader::CreateRenderShader(L"PointLight", 0,
		BIND_VS | BIND_HS | BIND_DS | BIND_PS);
	//m_mRenderShader.insert(pairShader("PointLight", pShader));
	m_mRenderShader.insert(make_pair("PointLight", pShader));
	...
	m_mRenderShader.insert(make_pair("DebugPointLight", pShader));
	...
	m_mRenderShader.insert(make_pair("CapsuleLight", pShader));
	...
	m_mRenderShader.insert(make_pair("DebugCapsuleLight", pShader));
	...
	m_mRenderShader.insert(make_pair("SpotLight", pShader));
	...
	m_mRenderShader.insert(make_pair("DebugSpotLight", pShader));
	//light shader
	...
	m_mRenderShader.insert(make_pair("RayTrace", pShader));
	//combine shader
	...
	m_mRenderShader.insert(make_pair("Combine", pShader));
}
...
UINT CResourceManager::CreateGJMResource(string path, string name) {
	...
	//m_mAnimater.SetAt((name.c_str()), pAnimater);
