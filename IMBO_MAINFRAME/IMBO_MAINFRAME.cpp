// IMBO_MAINFRAME.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//

#include "stdafx.h"
//#include "vld.h"
#include "IMBO_MAINFRAME.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_IMBO_MAINFRAME, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_IMBO_MAINFRAME));
